...
#include "../LabRab2Aistrd_Koryagin_9309/Haffman.h"
#include "../LabRab2Aistrd_Koryagin_9309/Tree.h"
#include "../LabRab2Aistrd_Koryagin_9309/Other.h"
...
namespace UnitTest2
{
	...
	public:
		TEST_METHOD(Coder_Test)
		{
			...
			hfTree->CodeDeveloper(hfTree->getRoot());
			RBTree<char, string> Hf_chart;
			hfTree->toTree(&Hf_chart, hfTree->getRoot());
		...
		TEST_METHOD(Decode_Test)
		{
			...
			Assert::IsTrue(hfTree->decoder(encode_str) == "Forget it");
		}
	};
}